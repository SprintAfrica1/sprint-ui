...
const CourierHeader: React.FC<CourierHeaderProps> = ({ onMenuClick }) => {
  ...
  const userName = "Musa K.";
  const userRole = "Courier Driver";
              ...
              <div className="dropdown profile-dropdown">
                <div className="profile-header">
                  ...
                  <div className="profile-info">
                    ...
                    <div className="profile-email">musa.k@example.com</div>
                  </div>
                </div>
